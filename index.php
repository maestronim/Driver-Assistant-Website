<?php
require_once 'requests/http_requests.php';
session_start();
...
if(isset($_REQUEST['register-submit'])) {
	if($_REQUEST['confirm-password'] == $_REQUEST['password']) {
		...
		//API Url
		$url = 'http://maestronim.altervista.org/Driver-Assistant/api/user-info/create.php';
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="authentication/style.css">
</head>
<body>
	<div class="container">
		<div class="row">
